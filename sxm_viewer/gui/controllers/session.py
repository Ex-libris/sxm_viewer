...
class SessionController:
    ...
    def _capture_canvas_snapshot(self, canvas, views_dir: Path, prefix: str, include_arrays: bool):
        ...
        snapshot = {
            ...
            "show_filter_summary_overlay": bool(display_state.get("show_filter_summary_overlay", getattr(canvas, "_show_filter_summary_overlay", False))),
                ...
                viewer._apply_canvas_style_snapshot(
                    canvas,
                    {
                        ...
                        "display_options": {
                            ...
                            "show_filter_summary_overlay": bool(snapshot.get("show_filter_summary_overlay", getattr(canvas, "_show_filter_summary_overlay", False))),
